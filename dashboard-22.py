...
if menu == "Projects Status":
    with st.container():
        ...
        if "PIC" in df.columns and df["PIC"].notna().sum() > 0:
            ...
            # Data proyek per PIC per prioritas dan gabungkan dengan total
            pic_priority_df = (
            ...
            # Gabungkan dengan total untuk pengurutan
            ...
            # Pastikan kolom Midpoint ada di pic_leaderboard dan urutkan sesuai total
            ...
            # Label total dengan urutan yang sama
